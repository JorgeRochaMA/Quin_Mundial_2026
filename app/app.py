...
with st.form("login_form"):
    ...
    remember_device = st.checkbox("Recordarme en este dispositivo")
...
if submitted:
    try:
        ...
        if remember_device and user.get("role") == ROLE_USER:
            ...
            st.success("Listo, ya estás dentro. Recordaremos este dispositivo.")
            st.stop()
